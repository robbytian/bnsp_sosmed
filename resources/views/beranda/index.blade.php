        ...
        <div class="d-flex">
            ...
            <div class="flex-grow-1">
                <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                    <div class="mr-3">
                        <a href="#" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">{{Auth::User()->name}}</a>
                    </div>
                </div>
                <form action="/post" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex align-items-center flex-wrap justify-content-end">
                        <textarea name="text_post" id="" class="form-control" required></textarea>
                    </div>
                    <label for="image" class="mt-2">
                        <i class="fa fa-image"></i>
                        <input type="file" id="image" name="image" style="display: none" accept="image/*" data-original-title="upload photos">
                    </label>
                    <label for="file" class="mt-2 ml-2">
                        <i class="fa fa-file"></i>
                        <input type="file" id="file" name="file" style="display: none">
                    </label>
                    <button class="btn btn-primary mt-3" style="float:right" type="submit">Kirim</button>
                </form>
            </div>
        </div>
    </div>
