...
var KTDatatableRecordSelectionDemo = (function () {
  ...
  return {
    init: function () {
      !(function () {
        (t.extensions = { checkbox: !0 }),
          (t.search = {
            input: $("#kt_datatable_search_query"),
            key: "generalSearch",
          });
        var e = $("#kt_datatable").KTDatatable(t);
        $("#kt_datatable_search_status").on("change", function () {
          ...
          e.on("datatable-on-check datatable-on-uncheck", function (t) {
            ...
            $("#kt_datatable_selected_records").html(a),
              a > 0
          ...
          $("#kt_datatable_fetch_modal")
            .on("show.bs.modal", function (t) {
              ...
              for (
                ...
                s.setAttribute("data-id", a[n]),
                  (s.innerHTML = "Selected record ID: " + a[n]),
                  l.appendChild(s);
              }
        ...
        (function () {
          ...
          var e = $("#kt_datatable_2").KTDatatable(t);
          $("#kt_datatable_search_status_2").on("change", function () {
            ...
            e.on("datatable-on-click-checkbox", function (t) {
              var a = e.checkbox().getSelectedId().length;
              $("#kt_datatable_selected_records_2").html(a),
                a > 0
